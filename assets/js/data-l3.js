  ...
  S['l3-boe'] = {
    ...
    blocks: [
      ...
      { t: 'formula', lbl: 'max 的正确位置 · Where the max belongs',
        html: '<span style="color:var(--green)">正确 ✓</span>&nbsp; E<sub>S′</sub>[ R + γ max<sub>a′</sub> q(S′,a′) ] &nbsp;&nbsp;·&nbsp;&nbsp; <span style="color:var(--red)">错误 ✗</span>&nbsp; max<sub>a′</sub> E<sub>S′</sub>[ R + γ q(S′,a′) ] &nbsp;&nbsp;<span style="color:var(--ink-3)">（上例：1 vs 0.5）</span>' },
  ...
  S['l3-solving'] = {
    ...
    blocks: [
      ...
      { t: 'formula', lbl: 'v* 与 q* 的互相表出 · Expressing v* and q* through each other',
        html: 'v<sup>*</sup>(s) = <span style="color:var(--gold)">max<sub>a</sub></span> q<sup>*</sup>(s,a) &nbsp;&nbsp;·&nbsp;&nbsp; q<sup>*</sup>(s,a) = Σ<sub>r</sub> p(r|s,a) r + γ Σ<sub>s′</sub> p(s′|s,a) <span style="color:var(--gold)">max<sub>a′</sub></span> q<sup>*</sup>(s′,a′)' },
