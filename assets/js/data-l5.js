  ...
  S['l5-mean'] = {
    ...
    blocks: [
      ...
      { t: 'formula', lbl: '同一期望，两条算法 · One expectation, two algorithms',
        html: 'DP：<span style="color:var(--violet)">Σ<sub>s′</sub> p(s′|s,a) [r + γ v(s′)]</span>（要模型） &nbsp;&nbsp;⟷&nbsp;&nbsp; MC：<span style="color:var(--green)">(1/n) Σᵢ gᵢ → E[G | s,a]</span>（要样本）' },
  ...
  S['l5-exploring'] = {
    ...
    blocks: [
      ...
      { t: 'formula', lbl: '增量式 MC 估计 · The incremental MC estimate',
        html: 'q(s,a) ← q(s,a) + <span class="mt">1/N(s,a)</span> ( g − q(s,a) ) &nbsp;&nbsp;<span style="color:var(--ink-3)">⟺ N 个回报的算术平均（α<sub>t</sub> = 1/t 的出生地）</span>' },
  ...
  S['l5-eps'] = {
    ...
    blocks: [
      ...
      { t: 'formula', lbl: '访问次数下界 · Visitation lower bound under ε-greedy',
        html: 'N<sub>t</sub>(s,a) ≥ (ε/|A|) · t → ∞ &nbsp;&nbsp;<span style="color:var(--ink-3)">（探索的预算律：ε 每减半，覆盖时间翻倍）</span>' },
